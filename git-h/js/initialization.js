...
window.applyTheme = function(themeId) {
	...
	forceColor('#themeBtn, #leaderboardBtn, #openSideBar, #pauseBtn, #restartBtn, #menuBtnPause, #musicWidget, #musicDropdown, .music-option, .vis-dot', theme.textColor);
...
$(document).ready(function() {
	...
	$(document).on('mousedown touchstart', '#themeBtn, #leaderboardBtn', function() {
		$('#musicContainer').fadeOut(150);
	});
	$(document).on('mousedown touchstart', '#closeThemes, #themesModal, #closeLeaderboard, #leaderboardModal', function(e) {
